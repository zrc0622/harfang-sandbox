...
| **算法**             | **击落成功率**       | **命中成功率**       | **奖励值**               |
|:-----------------:|:----------------:|:----------------:|:---------------------:|
|OurAdaptive_Agent_successRate100_Actor_Harfang_GYM| Ours(adaptive)  | **98.0%±1.3%**     | **98.0%±1.3%**     | **-1436.0±238.9**       |
|OurLinear_Agent_successRate100_Actor_Harfang_GYM| Ours(linear)| Ours(linear)    | 86.0%±5.4%     | 86.0%±5.4%     | -5800.8±1420.3      |
|TD3_Agent_successRate0_Actor_Harfang_GYM| TD3             | 0.0%±0.0%      | 0.0%±0.0%      | -5720.9±715.8       |
|ESAC_Agent_successRate100_Actor.pth| E-SAC           | 90.0%±2.8%     | 90.0%±2.8%     | -3722.2±395.5       |
|SAC_Agent_successRate100_Actor.pth| SAC             | 44.0%±3.3%     | 0.0%±0.0%      | -8318.1±822.8       |
|BC_Agent_successRate63_Harfang_GYM| BC              | 22.4%±3.2%     | 22.4%±3.2%     | -20504.7±1156.3     |

### 开火效率
| **算法**             | **命中次数/发射次数** |
|:-----------------:|:-----------------:|
|OurAdaptive_Agent_successRate100_Actor_Harfang_GYM| Ours(adaptive)  | **100.0%**          |
|OurLinear_Agent_successRate100_Actor_Harfang_GYM| Ours(linear)| Ours(linear)    | **100.0%**          |
|ESAC_Agent_successRate100_Actor.pth| E-SAC           | 11.4%           |
|BC_Agent_successRate63_Harfang_GYM| BC              | 92.3%           |
